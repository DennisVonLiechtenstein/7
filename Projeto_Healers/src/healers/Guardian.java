...
public class Guardian {
	...
	public void cadastroGuardian() throws IOException, InterruptedException {
		...
		while(allright==false) {
			...
			System.out.println(" Dados cadastrados. Email: "+email+" Senha: "+senha+" Nome:  "+nome+" Idade: "
					...
					+profissao+" Tipo de ajuda: "+situacao+" Disponibilidade: "+disponivel+"");
			...
			if((email.endsWith(".com") && senha.length()==8) && (nome.length() > 0 && idade > 18) && 
					...
					(situacao.equalsIgnoreCase("F") || situacao.equalsIgnoreCase("P") || situacao.equalsIgnoreCase("M")) &&
